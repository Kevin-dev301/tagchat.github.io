...
<head>
    ...
    <link rel="stylesheet" href="../../../css/active/main.css">
</head>
...
<body class="ofNav">
    ...
    <div class="friends-ui">
        <div class="friends-top">
            <h1>
                ...
                while ($fetch = mysqli_fetch_array($sql)) {
                    ...
                    $query = mysqli_query($conn, "SELECT * FROM user WHERE id = $user AND active = 1 AND active_availability = 1");
        ...
        <div class="friends-bottom">
            ...
            if ($add == 0) { ?>
                <p class="demos">None Of Your Friends Is Online</p>
            <?php } else {
                ...
                <ul id="people-cards">
                    ...
                    while ($fetch = mysqli_fetch_array($sql)) {
                        ...
                        if (mysqli_num_rows($query) > 0) {
                            $getQ = mysqli_fetch_array($query);
                            $useri = $getQ['id'];
                            $usern = $getQ['username'];
                            $userp = $getQ['profileimg'];
                            $userv = $getQ['verified'];
                    ?>
                            <li>
                                <div class="people-card-dv">
                                    <a href="../profile/?user=<?php echo $useri ?>" class="people-card-in">
                                        <div class="friend-profile">
                                            ...
                                            <?php } else { ?>
                                                <img src="../../../assets/users/<?php echo $userp ?>" alt="<?php echo $userp ?>'s_profile_picture">
                                            <?php } ?>
                                        </div>
                                        <div class="user">
                                            <span class="names"><?php echo $usern ?></span>
                                            <?php 
                                                if($userv == '1'){
                                            ?>
